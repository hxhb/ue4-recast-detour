...
class /*NAVMESH_API*/ dtPathCorridor
{
	...
	/*uint32*/unsigned int m_hasNextExpectedCorner : 1;
	/*uint32*/unsigned int m_hasNextExpectedCorner2 : 1;
	/*uint32*/unsigned int m_isInSkipRange : 1;
	/*uint32*/unsigned int m_enableEarlyReach : 1;
